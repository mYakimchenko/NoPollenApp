...
public class MessageViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(MessageEntity messageEntity) {
        String photoUrl = messageEntity.getPhotoUrl();
        ...
        if (messageEntity.getName() != null) {
            mName.setText(messageEntity.getName());
        } else {
            mName.setText(R.string.anonymous);
        }

        // TODO: convert into device locale
        mDateTime.setText(messageEntity.getDateTime());
        mTextMessage.setText(messageEntity.getText());
    }
}
